...
public class Ride {
    ...
    private String bike_bike_battery_level;
    ...
    private String bike_bike_fleet_key;
    ...
    private String bike_usage_surcharge;
    ...
    public String getBike_usage_surcharge() {
        return bike_usage_surcharge;
    }

    public void setBike_usage_surcharge(String bike_usage_surcharge) {
        this.bike_usage_surcharge = bike_usage_surcharge;
    }
    ...
    public String getBike_bike_battery_level() {
        return bike_bike_battery_level;
    }

    public void setBike_bike_battery_level(String bike_bike_battery_level) {
        this.bike_bike_battery_level = bike_bike_battery_level;
    }
    ...
    public String getBike_bike_fleet_key() {
        return bike_bike_fleet_key;
    }

    public void setBike_bike_fleet_key(String bike_bike_fleet_key) {
        this.bike_bike_fleet_key = bike_bike_fleet_key;
    }
    ...
    public String toString() {
        return "Ride{" +
                ...
                ", bike_bike_fleet_key='" + bike_bike_fleet_key + '\'' +
                ", bike_mac_id='" + bike_mac_id + '\'' +
                ", bike_bike_operator_id='" + bike_bike_operator_id + '\'' +
                ", bike_fleet_id=" + bike_fleet_id +

                ", bike_bike_name='" + bike_bike_name + '\'' +
                ", bike_make='" + bike_make + '\'' +
                ", bike_on_call_operator='" + bike_on_call_operator + '\'' +
                ", ride_booked_on=" + ride_booked_on +
