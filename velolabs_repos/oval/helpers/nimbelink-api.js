...
const { NIMBELINK_PROJECT_ID, NIMBELINK_SUBSCRIPTION_NAME, NIMBELINK_USER, NIMBELINK_AUTH, NIMBELINK_API_KEY, NIMBELINK_URL, S3_ACCESS_KEY_ID, S3_SECRET_ACCESS_KEY, BUCKET_NAME, BUCKET_KEY } = process.env
const s3 = new AWS.S3({
...
const initPubSub = async () => {
  try {
    ...
    logger('Error: Setting up pubsub.', error)
