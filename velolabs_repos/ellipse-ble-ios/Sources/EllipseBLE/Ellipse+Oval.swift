...
class Session: OvalAPI.Session {
}

fileprivate let endpoint = "https://lattisappv2.lattisapi.io/api"
...
fileprivate extension API {
    static let firmvareVersions = API(endpoint: endpoint, path: "locks/firmware-versions-for-operator")
    static let firmvare = API(endpoint: endpoint, path: "locks/firmware-for-operator")
    static let firmvareLog = API(endpoint: endpoint, path: "locks/firmware-log-for-operator")
    static let registration = API(endpoint: endpoint, path: "locks/registration-for-operator")
    static let signedMessage = API(endpoint: endpoint, path: "locks/signed-message-and-public-key-for-operator")
    static let fleet = API(endpoint: endpoint, path: "fleet/fleet-of-token")
    static let pinCode = API(endpoint: endpoint, path: "locks/save-pin-code")
    static let locks = API(endpoint: endpoint, path: "locks/get-locks")
}
...
fileprivate extension OvalAPI.Session {
