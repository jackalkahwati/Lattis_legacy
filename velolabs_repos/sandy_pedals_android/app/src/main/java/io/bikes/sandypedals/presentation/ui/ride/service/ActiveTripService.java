package io.bikes.sandypedals.presentation.ui.ride.service;
...
import io.bikes.sandypedals.R;
import io.bikes.sandypedals.SandyPedals;
import io.bikes.sandypedals.data.network.model.response.ride.RideSummaryResponse;
import io.bikes.sandypedals.data.network.model.response.ride.UpdateTripResponse;
...
import io.bikes.sandypedals.domain.interactor.ride.RideSummaryUseCase;
import io.bikes.sandypedals.domain.interactor.ride.UpdateRideUseCase;
import io.bikes.sandypedals.domain.model.Location;
import io.bikes.sandypedals.domain.model.Lock;
import io.bikes.sandypedals.presentation.model.LockModel;
...
import io.bikes.sandypedals.presentation.ui.ride.service.util.UpdateTripData;
...
import static io.bikes.sandypedals.domain.model.Lock.Connection.Status.GUEST_VERIFIED;
import static io.bikes.sandypedals.domain.model.Lock.Connection.Status.OWNER_VERIFIED;
...
public class ActiveTripService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        ((SandyPedals) getApplication()).getApplicationComponent().inject(this);
