    ...
    private class ServiceHandler {
        ...
        public String makeServiceCall(String url, int method,
            ...
            try {
                ...
                String one = "eyJhbGciOiJIUzI1NiIsImlhdCI6MTQ1ODg4NDY5OSwiZXhwIjoxNDY2NjYwNjk5fQ.eyJ1c2VybmFtZSI6IjQxNSJ9.caJTu6eRUCmbHiFUuExsX8dxeqefy_uC7ZN-Y38dJcE:";
                //  byte[] c = one.getBytes();
                String ret="Basic "+Base64.encodeToString(one.getBytes(),Base64.URL_SAFE|Base64.NO_WRAP);
