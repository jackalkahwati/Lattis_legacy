...
public class LED3Activity extends AppCompatActivity implements BluetoothDeviceStatus, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_title.setText("LED3 Test");
    ...
    private void setLedOnState() {
        ...
        imageButton5.setImageResource(R.drawable.green);
    }
        ...
        try {
            switch (v.getId()) {
                case R.id.button_ledon: {
                    if (mService != null) {
                        mService.ledON((byte) 0x10);
                        ledOnOFF = true;
                    } else
                        Toast.makeText(LED3Activity.this, "No BLE Connection", Toast.LENGTH_SHORT).show();
                }
                break;
                ...
                case R.id.bCapTouchNext: {
                    if (ledOnOFF)
                        mService.ledON((byte) 0x00);
                    finish();
                    Intent intent = new Intent(LED3Activity.this, SplashActivity.class);
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder rawBinder) {
            ...
            mService.ledON((byte) 0x00);
            mService.registerBluetoothDeviceStatusListener(LED3Activity.this);
    ...
    public void onConnectionFailed(boolean shippingModeEnabled) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                imageView_bleConnectionStatus.setImageResource(R.drawable.red);
                Toast.makeText(LED3Activity.this, "No BLE device", Toast.LENGTH_SHORT).show();
            }
        });
    }
