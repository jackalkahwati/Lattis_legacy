...
public class ChargingActivity2 extends AppCompatActivity implements BluetoothDeviceStatus {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_Instruction.setText("Unplug the USB charger to the lock's charging port. Press the Begin Test button to start the test. It will tell the result at the end of the test.");
        ...
        button_NextTest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                saveToDB();
                finish();
                Intent intent = new Intent(ChargingActivity2.this, SplashActivity.class);
    ...
    private void saveToDB() {
        ...
        FileUtils.writeFile(Myconstants.usb_charging_fileName + "2", data);
//        System.out.println(FileUtils.readFromFile(ChargingActivity2.this, Myconstants.usb_charging_fileName + "2"));
    }
    ...
    protected void onResume() {
        ...
        try {
            if (SkylockBluetoothLEService.mCurrentlyconnectedGatt != null) {
                ...
                Toast.makeText(ChargingActivity2.this, "No BLE device", Toast.LENGTH_SHORT).show();
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder rawBinder) {
            ...
            mService.registerBluetoothDeviceStatusListener(ChargingActivity2.this);
