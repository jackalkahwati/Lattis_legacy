...
public class LED1Activity extends AppCompatActivity implements BluetoothDeviceStatus, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_title.setText("LED1 Test");

    }

    private void setLedOnState() {
        imageButton1.setImageResource(R.drawable.red);
        imageButton2.setImageResource(R.drawable.red);
        imageButton3.setImageResource(R.drawable.red);
        ...
        try {
            switch (v.getId()) {
                case R.id.button_ledon: {
                    if (mService != null) {
                        mService.ledON((byte) 0x0F);
                        ledOnOFF = true;
                    } else
                        Toast.makeText(LED1Activity.this, "No BLE Connection", Toast.LENGTH_SHORT).show();
                }
                break;
                ...
                case R.id.bCapTouchNext: {
                    if (ledOnOFF)
                        mService.ledON((byte) 0x00);
                    finish();
                    Intent intent = new Intent(LED1Activity.this, SplashActivity.class);
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder rawBinder) {
            ...
            mService.ledON((byte) 0x00);
            mService.registerBluetoothDeviceStatusListener(LED1Activity.this);
    ...
    public void onConnectionFailed(boolean shippingModeEnabled) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                imageView_bleConnectionStatus.setImageResource(R.drawable.red);
                Toast.makeText(LED1Activity.this, "No BLE device", Toast.LENGTH_SHORT).show();
            }
        });
    }
