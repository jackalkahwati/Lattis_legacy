...
@application.route('/admin/<user_id>', methods = ['GET'])
#@admin_required
def admin(user_id):
    ...
    while count < len(admins):
        send_message(admins[count], text_message, render_template('Admin.txt', code=code))
        count=count+1
...
#Backup Method
@application.route('/metadata_ver/<int:id>', methods=['PUT'])
...
@application.route('/twilio_number/<int:id>', methods=['PUT'])
...
@application.route('/crash_threshold/<int:id>', methods=['PUT'])
...
@application.route('/theft_threshold_low/<int:id>', methods=['PUT'])
...
@application.route('/theft_threshold_med/<int:id>', methods=['PUT'])
...
@application.route('/theft_threshold_high/<int:id>', methods=['PUT'])
...
@application.route('/shackle_insertion_x/<int:id>', methods=['PUT'])
...
@application.route('/shackle_insertion_y/<int:id>', methods=['PUT'])
...
@application.route('/shackle_insertion_z/<int:id>', methods=['PUT'])
...
@application.route('/rssi/<int:id>', methods=['PUT'])
def rssi(id):
...
@application.route('/battery/<int:id>', methods=['PUT'])
def battery(id):
...
@application.route('/update_detail/<int:id>', methods=['PUT'])
