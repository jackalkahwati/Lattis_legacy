...
constructor(private val accountManager: AccountManager,
            ...
            @param:Named("AuthenticationTokenType") val tokenType: String) : AccountRepository {
    ...
    private fun setResult(account: Account, subscriber: Emitter<in Account>, newAccount: android.accounts.Account) {
        ...
        accountManager.setUserData(newAccount, USER_DATA_USERS_ID_KEY, account.usersId)
        accountManager.setUserData(newAccount, USER_DATA_USER_TYPE_KEY, account.userType)
        accountManager.setUserData(newAccount, USER_DATA_USER_VERIFIED, java.lang.Boolean.toString(account.isVerified?:false))
