package com.lattis.domain.mapper.ride_bike
...
class BikeModelMapper @Inject constructor(
    @param:Named("UUID") val uuid:String
) : AbstractDataMapper<Bike, Ride>() {
    override fun mapIn(bike: Bike?): Ride {
        ...
        if (bike != null) {
            ...
            ride.payment_gateway = bike.payment_gateway
            ...
            ride.promotions = bike.promotions
        }
        return ride
    }
    ...
    override fun mapOut(ride: Ride?): Bike? {
        ...
        ride?.let {
            ...
            bike.payment_gateway = ride.payment_gateway
            ...
            bike.promotions = ride.promotions
        }
        return bike
    }
}