...
import com.lattis.lattis.utils.AccountAuthenticatorHelper.APP_START_BUNDLE
import com.lattis.lattis.utils.AccountAuthenticatorHelper.APP_STATUS_BUNDLE
...
//        }
    ...
    private fun generateAuthTokenBundle(accountName: String, authToken: String): Bundle {
        ...
        bundle.putString(AccountManager.KEY_ACCOUNT_TYPE, "com.lattis.lattis")
    ...
    private fun getLoginBundle(context: Context,
        ...
        if(options!=null &&
            options.containsKey(APP_STATUS_BUNDLE) &&
            options.getString(APP_STATUS_BUNDLE)!=null && options.getString(APP_STATUS_BUNDLE).equals(APP_START_BUNDLE)){
            intent = Intent(context, SignUpActivity::class.java)
        }else{
            intent = Intent(context, SignInActivity::class.java)
        }
