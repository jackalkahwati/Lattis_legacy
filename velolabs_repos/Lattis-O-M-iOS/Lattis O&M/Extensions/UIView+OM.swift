...
public extension UIView {
    ...
    public func constrainEqual(_ attribute: NSLayoutConstraint.Attribute, to: AnyObject?, _ toAttribute: NSLayoutConstraint.Attribute, multiplier: CGFloat = 1, constant: CGFloat = 0) -> NSLayoutConstraint {
