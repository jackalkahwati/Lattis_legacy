...
public class Ranger extends HorizontalScrollView implements View.OnClickListener {
    ...
    public static final int DAY_SELECTED_INDICATOR = R.id.day_selected_indicator;
    //Delay
    ...
    public static class DayView {
        ...
        LinearLayout mView,mDaySelectedIndicator;
        TextView mDayOfWeek;
        TextView mDayNumber;
        ...
        public DayView(View view) {
            ...
            mDaySelectedIndicator = (LinearLayout)  mView.findViewById(DAY_SELECTED_INDICATOR);
        }
        ...
        public void setBackgroundColor(int color) {
            mDaySelectedIndicator.setBackgroundColor(color);
        }
