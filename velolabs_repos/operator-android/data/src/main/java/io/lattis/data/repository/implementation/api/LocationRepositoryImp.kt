...
class LocationRepositoryImp @Inject constructor(
    ...
    private val locationSettingsSubject: PublishSubject<io.lattis.domain.models.LocationSettingsResult> = PublishSubject.create()
...
//            locationUpdateStarted=true
    ...
    override fun getLocationSettings(): Observable<io.lattis.domain.models.LocationSettingsResult>
        {
            ...
            task.addOnSuccessListener {
                val locationSettingsResult = io.lattis.domain.models.LocationSettingsResult()
